...
class ModelProcessor:
    def __init__(self):
        ...
        self.model_Mapper={
            "Cotton":"./Models/Crop_Disease_Detection/Cotton/DefinedModel.h5",
            "Sugarcane":"./Models/Crop_Disease_Detection/Sugarcane/DefinedModel.h5",
            "Wheat":"./Models/Crop_Disease_Detection/Wheat/DefinedModel.h5"
        }
    ...
    def predictDiseaseClass(self,image_array,crop_type):
        print(image_array.shape)
        model=tensorflow.keras.models.load_model(self.model_Mapper[crop_type])
